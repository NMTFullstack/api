...
const Vanthu_de_xuat = new Schema({
    ...
    noi_dung: {
        ...
        //Đề xuất sửa chưa tài sản cấp phát
        ...
        di_muon_ve_som: {
            ...
            ly_do: {
                type: String,
                default: null, // L� do chung c?a m?i lo?i d? xu?t
            },
        ...
        nghi_phep_ra_ngoai: {
            ...
            bd_nghi: { //ng�y b?t d?u ngh?
                type: Number,
                default: null,

            },
            kt_nghi: { // Ng�y k?t th�c ngh?
                type: Number,
                default: null,
            },
            ca_nghi: {
            ...
            ly_do: {
                type: String, // L� do chung c?a m?i lo?i d? xu?t
                default: null,
            },
        },
