...
router.post('/customer', formData.parse(), ToolCRM.toolCustomer)
router.post('/customer/update', formData.parse(), ToolCRM.toolCustomerUpdate)
...
router.post('/detailFormContract', ToolCRM.toolDetailFormContract)
...
router.post('/customerGroup', formData.parse(), ToolCRM.toolCustomerGroup)
...
router.post('/appointmentContentCall', formData.parse(), ToolCRM.appointment_content_call)
